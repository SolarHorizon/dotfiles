...
_G.packer_plugins = {
  ["galaxyline.nvim"] = {
    loaded = true,
    path = "/home/matt/.local/share/nvim/site/pack/packer/start/galaxyline.nvim",
    url = "https://github.com/glepnir/galaxyline.nvim"
  },
  ["nvim-lint"] = {
    loaded = true,
    path = "/home/matt/.local/share/nvim/site/pack/packer/start/nvim-lint",
  ...
  ["onedark.vim"] = {
    loaded = true,
    path = "/home/matt/.local/share/nvim/site/pack/packer/start/onedark.vim",
  ...
  ["stylua-nvim"] = {
    loaded = true,
    path = "/home/matt/.local/share/nvim/site/pack/packer/start/stylua-nvim",
