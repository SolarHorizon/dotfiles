...
local buttons = {
	...
	val = {
		...
		dashboard.button("<Ctrl> g", "  Live grep"),
		dashboard.button(
			"c",
			"  Configuration",
			"<cmd>cd ~/.config/nvim/ | NeoTreeShow<CR>"
		),
		dashboard.button("l", "󰐱  Open Lazy", "<cmd>Lazy<CR>"),
		dashboard.button("m", "ﳼ  Open Mason", "<cmd>Mason<CR>"),
